...
//		String opening, String director, String runtime, String synopsis, Boolean blockBuster, ArrayList<String> cast)
		...
		m1_cast.addAll(Arrays.asList("Joaquin Phoenix, Robert De Niro, Zazie Beetz, Bill Camp, Frances Conroy, Brett Cullen, Glenn Fleshler, Douglas Hodge"));
		...
		m2_cast.addAll(Arrays.asList("Yann Yann Yeo, Koh Jia Ler, Christopher Lee, Yang Shi Bin"));
		...
		m3_cast.addAll(Arrays.asList("Kristen Stewart, Naomi Scott, Ella Balinska, Elizabeth Banks, Djimon Hounsou, Noah Centineo, Sam Claflin, Patrick Stewart"));
		...
		m4_cast.addAll(Arrays.asList("Tom Holland, Samuel L. Jackson, Jake Gyllenhaal, Marisa Tomei, Jon Favreau, Zendaya , Jacob Batalon, Tony Revolori"));
		...
		m5_cast.addAll(Arrays.asList("Chloe Bennet, TenzNorgay Trainor, Albert Tsai, Eddie Izzard, Sarah Paulson, Tsai Chin, Michelle Wong"));
		...
		m6_cast.addAll(Arrays.asList("Hairul Azreen, Fify Azmi, Hilal Azman, Ismi Melinda, Henley Hii, Dain Iskandar Said, Josiah Hogan, Yayan Ruhian"));

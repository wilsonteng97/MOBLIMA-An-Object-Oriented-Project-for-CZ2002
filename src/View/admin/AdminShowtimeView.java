...
public class AdminShowtimeView extends View {
	...
	private void removeShowtime(Movie movieIn, ShowTime showTimeIn) {
		...
		System.out.println("Are You sure you want to remove showtime " + (String) (formatter.format(showTimeIn))
				+ " for " + movieIn.getTitle() + " Y/N");
		String choice = sc.next();
		if (confirmChoice(choice)) {
			removeShowtime(movieIn, showTimeIn);
			System.out.println(
					(String) (formatter.format(showTimeIn)) + " showtime has been removed from " + movieIn.getTitle());
		} else {
			System.out.println("Failed to remove showtime " + (String) (formatter.format(showTimeIn)) + " from "
					+ movieIn.getTitle());
		}
		displayMenu();
	}
	...
	private Cinema getCinema() {
		...
		int choiceCinemaOperator = passChoiceInt("Choose Cinema Operator: ");
		CinemaOperator cinemaOperator = cinemaOperatorList.get(choiceCinemaOperator);
		...
		int choiceCinema = passChoiceInt("Choose Cinema: ");
